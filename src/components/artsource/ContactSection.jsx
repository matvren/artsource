          ...
          <div key={contact.name} className="bg-card border border-border rounded-xl p-5 hover:border-foreground/20 transition-all">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium transition-all ${copied[contact.discord] ? 'bg-foreground/10 text-foreground/60' : 'bg-white/5 text-foreground/70 hover:bg-white/10'}`}
              >
              ...
              <a
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium bg-white/5 text-foreground/70 hover:bg-white/10 transition-all"
              >
                <svg className="w-3.5 h-3.5 opacity-50" viewBox="0 0 24 24" fill="currentColor">
